            ...
            >
                ...
                <dl class="mt-4 space-y-2.5 text-sm">
                    <div class="flex justify-between">
                        <dt class="text-ink-700">{{ t('nav.cashIn') }}</dt>
                        <dd><MoneyText :value="today.cash_in" /></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-ink-700">{{ t('nav.cashOut') }}</dt>
                        <dd><MoneyText :value="today.cash_out" /></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-ink-700">{{ t('nav.transfer') }}</dt>
                        <dd><MoneyText :value="today.transfer" /></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-ink-700">{{ t('nav.exchange') }}</dt>
                        <dd><MoneyText :value="today.exchange" /></dd>
                    </div>
                </dl>
            </section>
        </div>
            ...
            <Link
                ...
                :class="
                    locked
                        ...
                        : 'hover:-translate-y-0.5 hover:border-ink-700 hover:shadow-sm'
                "
            >
                <p class="font-display font-semibold">{{ a.label }}</p>
                <p class="mt-1 text-xs leading-relaxed text-ink-700/70">
                    {{ a.note }}
                </p>
            </Link>
        </div>
