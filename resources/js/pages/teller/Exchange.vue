...
const reviewLines = computed<ReviewLine[]>(() => [
    ...
    {
        label: `${t('transaction.direction')} ${currency.value}`,
    ...
    {
        label: t('transaction.floatAfterExchange'),
        ...
        <template v-if="completed">
            <header class="mb-6 text-center">
                <h1 class="font-display text-2xl font-semibold tracking-tight">
                    {{ t('transaction.exchange') }} ပြီးပါပြီ
                </h1>
            ...
            <ReceiptSlip
                :txn="completed"
                next-href="/teller/exchange"
                :next-label="t('transaction.exchange')"
            />
        </template>
                    ...
                    >
                        <div class="grid gap-5">
                            ...
                            <div>
                                ...
                                <div
                                    class="mt-1.5 grid grid-cols-2 overflow-hidden rounded-counter border border-paper-edge"
                                >
                                    <button
                                        type="button"
                ...
                >
                    ...
                    <dl class="mt-4 space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <dd class="money">{{ rate.sell_rate }}</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-ink-300">
                                {{ t('transaction.buyRate') }}
                            </dt>
                            <dd class="money">{{ rate.buy_rate }}</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-ink-300">
                                {{ t('transaction.direction') }}
                        ...
                        <div class="flex justify-between">
                            <dt class="text-ink-300">
                                {{ t('transaction.floatAfterExchange') }}
                            </dt>
                            <dd>
                                <MoneyText
