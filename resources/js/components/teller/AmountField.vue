...
<template>
    <div>
        ...
        <p
            id="teller-amount-reading"
            class="mt-1.5 min-h-5 text-sm font-medium"
            aria-live="polite"
            :class="modelValue > 0 ? 'text-ink-800' : 'text-transparent'"
        >
            {{ reading || '-' }}
            <span v-if="modelValue > 0" class="text-ink-700/50">ကျပ်</span>
        </p>
