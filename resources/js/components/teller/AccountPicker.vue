...
const filtered = computed(() => {
    ...
    const list = q
        ? props.accounts.filter((a) =>
              `${a.company} ${a.name}`.toLowerCase().includes(q),
          )
        : props.accounts;
...
<template>
    <div class="relative">
        ...
        >
            <span>
                <span
                    class="block text-[11px] font-semibold tracking-wide text-ink-700/60 uppercase"
