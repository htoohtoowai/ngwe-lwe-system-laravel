...
const filtered = computed(() => {
    ...
    return rows.value.filter((row) => {
        ...
        const matchesFilters =
            (!selectedType.value ||
                row.transaction_type === selectedType.value) &&
...
watch([search, selectedType, dateFrom, dateTo, pageSize], () => {
    page.value = 1;
});
            ...
            >
                <div>
                    <h1
                        ...
                        :class="
                            transactionType
                                ? transactionTone(transactionType).text
                                : 'text-ink'
                        "
                    >
                        {{ title }}
                        ...
                        <tbody class="divide-y divide-line">
                            <tr v-for="row in paginated" :key="row.id">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <Link
                                        :href="`/admin/transactions/${row.id}?branch_id=${selectedBranchId}`"
