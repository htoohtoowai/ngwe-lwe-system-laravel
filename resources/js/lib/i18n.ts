...
function repairMojibake(value: string): string {
  if (typeof TextDecoder === 'undefined' || !/[\u00c0-\u00ff\u20ac\u2013\u2014]/.test(value)) {
    return value
  }
...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dashboard.pendingReviewHint': 'Confirm only after received cash, handoff and change agree.',
    ...
    'dashboard.verifyBeforeConfirm': 'Verify denominations before confirming',
    'dashboard.denominationReviewHint': 'Check customer cash, Teller change, and the exact Cashier handoff before confirming.',
    ...
    'dashboard.confirmCashInWithPinHint': 'Enter your Cashier PIN to post this handoff into the main vault.',
    ...
    'transaction.feePaymentCashHint': 'Include the fee in the cash movement.',
    'transaction.feePaymentAccount': 'Account',
    'transaction.feePaymentAccountHint': 'Debit the source account and credit a fee account.',
    ...
    'transaction.feeAccountRequired': 'Choose the account that will receive this fee.',
    ...
    'transaction.cashInCountPrerequisite': 'Choose the account and enter the Cash In amount before counting notes.',
    'transaction.cashInDenominationHint': "Count the customer's cash. If change is needed, count it from your Teller vault. The Cashier handoff is calculated automatically.",
    'transaction.cashInDescription': "Take the customer's cash, deduct the account, and hand the slip to the cashier for confirmation.",
    'transaction.afterCashierConfirmation': 'after Cashier confirmation',
    'transaction.cashOutDescription': 'Pay cash from your teller vault and record the account credit.',
    'transaction.transferDescription': 'Move value between accounts and settle the notes from your teller vault.',
    'transaction.exchangeDescription': 'Record a currency exchange using the live buy and sell rates from the server.',
    'transaction.customerName': 'Customer name',
    'transaction.customerPhone': 'Customer phone',
    'transaction.cashShort': 'Received cash is less than the Cash In amount.',
    'transaction.changeNotice': 'Give the change from your own teller vault.',
    'transaction.floatAfterChange': 'Teller vault after change',
    'transaction.cashInConsequence': 'The account is deducted immediately. The main vault is credited only when the cashier confirms the handoff.',
    'transaction.cashOutConsequence': 'The exact notes are deducted from your teller vault and the account is credited.',
    'transaction.transferConsequence': 'The source account is debited, the destination account is credited, and the exact notes are deducted from your teller vault.',
    'transaction.exchangeConsequence': 'The exchange account is credited and the exact notes are deducted from your teller vault.',
    'transaction.completedHint': 'Show this reference to the customer after checking the details.',
    'transaction.slip': 'Slip',
    'transaction.rate': 'Rate',
    'transaction.floatCashPaid': 'Teller vault cash paid',
    'transaction.floatShort': 'Your teller vault does not have enough cash. Reduce the amount or ask the cashier for a top-up.',
    ...
    'transaction.cashierLocked': 'Cashiers review and confirm transactions, but cannot create new entries from this screen.',
    'transaction.floatLocked': 'Your float is not active. Receive a float from the cashier before entering transactions.',
    ...
    'teller.cashOutNote': 'Pay cash from your teller vault; the account is credited.',
    ...
    'teller.noRecentEntries': 'Nothing entered yet. Your first transaction of the day appears here.',
    'teller.floatDescription': 'Cash you are personally accountable for until the cashier signs it back in.',
    'teller.noFloat': 'No float issued',
    'teller.askCashier': 'Ask the cashier to issue one. It will appear here to be counted, and the counter opens as soon as you receive it.',
    'teller.countIssued': 'The cashier issued the float. Count every note yourself.',
    'teller.countMatch': "Quantities must match the cashier's note-for-note, not just in total.",
    'teller.systemOnHand': 'System says on hand',
    'teller.youCounted': 'You counted',
    'teller.returnCloses': 'Once returned, the counter closes until a new float is issued.',
    ...
    'teller.noActiveFloat': 'No active float. Ask the cashier to issue one.',
    'teller.pendingReceipt': 'A float is waiting for you. Count the notes and receive it with your PIN before serving customers.',
    'teller.pendingReconciliation': 'Your float is with the cashier for confirmation. The counter reopens once it is closed and a new float is issued.',
    ...
    'component.accountBelowRequired': 'Balance is below the required amount.',
    ...
    'component.cashierConfirmHint': 'Hand the cash to the cashier. This slip completes when they confirm it into the vault.',
  ...
  mm: {
    ...
    'common.pinHint': 'ဂဏန်း ၄–၈ လုံး။ မှားယွင်းမှု ၃ ကြိမ်ဖြစ်လျှင် လုပ်ဆောင်ချက်ကို ခေတ္တပိတ်ပါမည်။',
    ...
    'dashboard.pendingReviewHint': 'လက်ခံရငွေ၊ အပ်ငွေနဲ့ အကြွေအမ်းငွေ ကိုက်ညီမှသာ အတည်ပြုပါ။',
    ...
    'dashboard.denominationReviewHint': 'လက်ခံရငွေ၊ Teller အကြွေအမ်းငွေ၊ Cashier အပ်ငွေကို အတည်မပြုမီ စစ်ပါ။',
    ...
    'dashboard.confirmCashInWithPinHint': 'ဒီငွေကို ပင်မငွေသေတ္တာထဲ စာရင်းသွင်းရန် Cashier PIN ထည့်ပါ။',
    ...
    'transaction.feePaymentCashHint': 'ဝန်ဆောင်ခကို ငွေသားလှုပ်ရှားမှုထဲ ထည့်မည်။',
    'transaction.feePaymentAccount': 'အကောင့်ဖြင့်',
    'transaction.feePaymentAccountHint': 'မူလအကောင့်မှ နုတ်ပြီး ဝန်ဆောင်ခအကောင့်ထဲ တိုးမည်။',
    'transaction.feeAccount': 'ဝန်ဆောင်ခထည့်မည့်အကောင့်',
    'transaction.chooseFeeAccount': 'ဝန်ဆောင်ခထည့်မည့်အကောင့် ရွေးပါ',
    'transaction.noFeeAccounts': 'အသုံးပြုနိုင်သော ဝန်ဆောင်ခအကောင့် မရှိသေးပါ။',
    'transaction.feeAccountRequired': 'ဝန်ဆောင်ခ လက်ခံမည့်အကောင့်ကို ရွေးပါ။',
    ...
    'transaction.cashInCountPrerequisite': 'ငွေစက္ကူရေတွက်ရန် အကောင့်ကိုရွေးပြီး Cash In ပမာဏကို အရင်ထည့်ပါ။',
    'transaction.cashInDenominationHint': 'ဖောက်သည်ထံမှ လက်ခံရငွေကို ရေတွက်ပါ။ အကြွေလိုပါက မိမိ Teller ငွေခွဲမှ အကြွေကို ရေတွက်ပါ။ Cashier ထံ အပ်မည့်ငွေကို စနစ်က အလိုအလျောက်တွက်ချက်ပါမယ်။',
    'transaction.cashInDescription': 'ဖောက်သည်ထံမှ ငွေသားလက်ခံပြီး အကောင့်ကို နုတ်ကာ Cashier ထံ အတည်ပြုရန် စာရင်းပေးပါ။',
    'transaction.afterCashierConfirmation': 'Cashier အတည်ပြုပြီးနောက်',
    'transaction.cashOutDescription': 'မိမိ Teller ငွေခွဲမှ ငွေထုတ်ပေးပြီး အကောင့်ထဲ ငွေဝင်ကြောင်း စာရင်းသွင်းပါ။',
    'transaction.transferDescription': 'အကောင့်များအကြား ငွေလွှဲပြီး မိမိ Teller ငွေခွဲမှ ငွေစက္ကူများကို စီမံပါ။',
    'transaction.exchangeDescription': 'Server မှ လက်ရှိဝယ်ဈေး၊ ရောင်းဈေးများကို အသုံးပြုပြီး ငွေလဲစာရင်းသွင်းပါ။',
    ...
    'transaction.changeNotice': 'အကြွေအမ်းငွေကို မိမိ Teller ငွေခွဲမှ ပေးရပါမယ်။',
    'transaction.floatAfterChange': 'အကြွေလဲပြီးနောက် Teller ငွေခွဲ',
    'transaction.cashInConsequence': 'အကောင့်လက်ကျန်ကို ချက်ချင်းနုတ်ပါမယ်။ Cashier က ငွေအပ်လက်ခံကြောင်း အတည်ပြုပြီးမှ အဓိကငွေသေတ္တာထဲ ငွေဝင်ပါမယ်။',
    'transaction.cashOutConsequence': 'သတ်မှတ်ထားသော ငွေစက္ကူများကို မိမိ Teller ငွေခွဲမှ နုတ်ပြီး အကောင့်ထဲ ငွေဝင်ပါမယ်။',
    'transaction.transferConsequence': 'မူလအကောင့်ကို နုတ်ပြီး သွားမည့်အကောင့်ထဲ ငွေဝင်ပါမယ်။ သတ်မှတ်ထားသော ငွေစက္ကူများကို မိမိ Teller ငွေခွဲမှ နုတ်ပါမယ်။',
    'transaction.exchangeConsequence': 'ငွေလဲမည့်အကောင့်ထဲ ငွေဝင်ပြီး သတ်မှတ်ထားသော ငွေစက္ကူများကို မိမိ Teller ငွေခွဲမှ နုတ်ပါမယ်။',
    'transaction.completedHint': 'အသေးစိတ်စစ်ဆေးပြီးနောက် ဒီရည်ညွှန်းနံပါတ်ကို ဖောက်သည်အား ပြပါ။',
    'transaction.slip': 'လက်ခံစာ',
    'transaction.rate': 'ဈေးနှုန်း',
    'transaction.floatCashPaid': 'Teller ငွေခွဲမှ ပေးထားသောငွေ',
    'transaction.floatShort': 'မိမိ Teller ငွေခွဲတွင် ငွေမလုံလောက်ပါ။ ပမာဏလျှော့ပါ သို့မဟုတ် Cashier ထံမှ ငွေဖြည့်တောင်းပါ။',
    ...
    'transaction.cashierLocked': 'Cashier က စာရင်းပြန်စစ်ပြီး အတည်ပြုနိုင်ပါတယ်။ ဒီနေရာကနေ စာရင်းအသစ် မသွင်းနိုင်ပါ။',
    'transaction.floatLocked': 'ကိုယ်ပိုင်ငွေခွဲ မဖွင့်ရသေးပါ။ စာရင်းမသွင်းမီ Cashier ထံမှ ငွေခွဲလက်ခံပါ။',
    ...
    'transaction.tellerVaultNetChange': 'Teller ငွေခွဲ စုစုပေါင်းပြောင်းလဲမှု',
    'transaction.tellerDenominationChange': 'Teller ငွေခွဲ အမျိုးအစားပြောင်းလဲမှု',
    ...
    'teller.noActiveFloat': 'အသုံးပြုနိုင်သော ငွေခွဲမရှိပါ။ Cashier ထံမှ ငွေခွဲတောင်းပါ။',
    'teller.pendingReceipt': 'သင့်အတွက် ငွေခွဲစောင့်နေပါတယ်။ ဖောက်သည်များကို မဝန်ဆောင်မီ ငွေစက္ကူများကို ရေတွက်ပြီး PIN ဖြင့် လက်ခံပါ။',
    'teller.pendingReconciliation': 'သင့်ငွေခွဲကို Cashier ထံ စာရင်းစစ်ရန် အပ်ထားပါတယ်။ စာရင်းပိတ်ပြီး ငွေခွဲအသစ်ထုတ်ပေးမှ ကောင်တာပြန်ဖွင့်ပါမယ်။',
    ...
    'teller.cashInNote': 'ဖောက်သည်က ငွေပေးပြီး အကောင့်လက်ကျန်ကို နုတ်ပါမယ်။',
    'teller.cashOutNote': 'မိမိ Teller ငွေခွဲမှ ငွေပေးပြီး အကောင့်ထဲ ငွေဝင်ပါမယ်။',
    ...
    'teller.noRecentEntries': 'စာရင်းမရှိသေးပါ။ ယနေ့ပထမဆုံးစာရင်းကို ဒီနေရာမှာ ပြပါမယ်။',
    'teller.floatDescription': 'Cashier ထံ ပြန်အပ်ပြီး စာရင်းပိတ်သည်အထိ သင့်တာဝန်ယူထားရမည့် ငွေသားဖြစ်ပါတယ်။',
    'teller.noFloat': 'ငွေခွဲ မထုတ်ပေးရသေးပါ',
    'teller.askCashier': 'Cashier ထံမှ ငွေခွဲထုတ်ခိုင်းပါ။ ထုတ်ပေးပြီးနောက် ဒီနေရာမှာ ရေတွက်လက်ခံနိုင်ပြီး ကောင်တာဖွင့်ပါမယ်။',
    'teller.countIssued': 'Cashier က ငွေခွဲထုတ်ပေးထားပါတယ်။ ငွေစက္ကူတစ်ရွက်ချင်း ရေတွက်ပါ။',
    'teller.countMatch': 'စုစုပေါင်းပမာဏတင်မဟုတ်ဘဲ ငွေစက္ကူအမျိုးအစားနဲ့ အရေအတွက်ပါ ကိုက်ညီရပါမယ်။',
    'teller.systemOnHand': 'စနစ်အရ လက်ကျန်',
    'teller.youCounted': 'သင်ရေတွက်ထားသည်',
    'teller.returnCloses': 'ပြန်အပ်ပြီးပါက ငွေခွဲအသစ် မထုတ်ပေးမချင်း ကောင်တာပိတ်ထားပါမယ်။',
    'teller.confirmCount': 'ငွေခွဲရေတွက်ပြီးကြောင်း အတည်ပြုပါ',
    'teller.confirmReturn': 'ပြန်အပ်မည့်ငွေကို အတည်ပြုပါ',
    'teller.pinCount': 'ငွေစက္ကူများ ကိုက်ညီကြောင်း သင့် PIN ဖြင့် မှတ်တမ်းတင်ပါမယ်။',
    'teller.pinReturn': 'ပြန်အပ်သည့်စာရင်းကို သင့် PIN ဖြင့် မှတ်တမ်းတင်ပါမယ်။',
    ...
    'component.accountBelowRequired': 'အကောင့်လက်ကျန်က လိုအပ်သောပမာဏထက် နည်းနေပါတယ်။',
    ...
    'component.cashierConfirmHint': 'ငွေကို Cashier ထံ အပ်ပါ။ Cashier က အတည်ပြုပြီးမှ ငွေသေတ္တာထဲ စာရင်းဝင်ပါမယ်။',
...
export function useLocale() {
  ...
  function t(key: string, fallback?: string): string {
    return repairMojibake(messages[locale.value][key] ?? messages.en[key] ?? fallback ?? key)
  }
